...
const Footer = () => {
  ...
  const handleNewsletterClick = (e) => {
    if (location.pathname !== '/') {
      ...
      e.preventDefault();
      navigate('/');
      // Attendre que la page d'accueil soit chargée avant de faire défiler
      setTimeout(() => {
      ...
      // Si nous sommes déjà sur la page d'accueil, simplement faire défiler
      e.preventDefault();
      const element = document.getElementById('newsletter');
      if (element) {
        element.scrollIntoView({ behavior: 'smooth' });
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="footer-newsletter">
              ...
              <a href="#newsletter" className="newsletter-link" onClick={handleNewsletterClick}>
                S'abonner →
              </a>
            </div>
          </div>
